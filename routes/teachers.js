...
const { GetTeachers, GetTeacher,GetTeacherByUserId,createquiz,GetTeachersPercentage, CreateTeacher,GetMyProfile, UpdateTeacher, DeleteTeacher, FollowTeacher } = require('../controller/TeacherController');
